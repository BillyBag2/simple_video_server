...
// #error "JC-ESP32-P4-M3-DEV board is not completed yet"
...
#error "MIPI-CSI camera motor is not supported by default"
...
#error "DVP interface camera sensor is not supported  by default"
#endif /* CONFIG_EXAMPLE_ENABLE_DVP_CAM_SENSOR */

#if CONFIG_EXAMPLE_ENABLE_SPI_CAM_SENSOR
#error "SPI interface camera sensor is not supported on by default"
